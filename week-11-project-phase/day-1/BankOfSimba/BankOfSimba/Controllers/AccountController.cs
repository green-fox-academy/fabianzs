...
namespace BankOfSimba.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult RaiseBalance(int animalIndex)
        {
            ...
            AccountListViewModel.BankAccounts[animalIndex - 1].RaiseBalance();

            //return RedirectToAction("List");
            return RedirectToAction("ListWithViewModel");
        }
        ...
        [HttpPost("add")]
        public IActionResult Add(BankAccount bankAccount /*BankAccount bankAccount*/)
        {
            //BankAccounts.Add(bankAccount);
            AccountListViewModel.BankAccounts.Add(bankAccount);
